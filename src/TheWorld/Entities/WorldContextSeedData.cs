...
namespace TheWorld.Entities
{
    public class WorldContextSeedData
    {
        ...
        {
            #region Identity
            if (await this.userManager.FindByEmailAsync("sam.hastings@theworld.com") == null)
            {
            ...
            if (!this.context.Trips.Any())
            {
                ...
                this.context.Trips.Add(usTrip);
                this.context.Stops.AddRange(usTrip.Stops);

                #endregion

                #region World Trip Seed
                ...
                this.context.Trips.Add(worldTrip);
                this.context.Stops.AddRange(worldTrip.Stops);
                #endregion
